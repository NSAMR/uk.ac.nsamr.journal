        ...
        <footer class="footer" id="footer">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <span>&copy; © Copyright 2016-2017 Student Association of Medical Research. Licensed under <a href="https://creativecommons.org/licenses/by/4.0/">CC-BY version 4.0</a> All Rights Reserved.</span>
                </div>
            </div>
        </footer>
        <!--footer end-->
