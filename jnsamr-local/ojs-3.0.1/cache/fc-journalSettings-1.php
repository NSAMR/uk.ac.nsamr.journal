<?php return array (
  ...
  'contactEmail' => 'byrnem@nsamr.ac.uk',
...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  'printIssn' => '',
  'publicationFee' => 0,
  'publisherInstitution' => 'National Student Association of Medical Research',
  'purchaseArticleFee' => 0,
  'referencesEnabledSubmission' => true,
  'referencesEnabledWorkflow' => true,
  'referencesRequired' => false,
  'rightsEnabledSubmission' => true,
  'rightsEnabledWorkflow' => true,
  ...
  'subjectEnabledSubmission' => true,
  'subjectEnabledWorkflow' => true,
  ...
  'typeEnabledSubmission' => true,
  'typeEnabledWorkflow' => true,
  'typeRequired' => false,
  'abbreviation' => 
  array (
    'en_US' => 'J Nat Stu Assoc Med Res',
  ),
  'about' => 
  array (
    'en_US' => '<p>The Journal of the&nbsp;National Student Association of Medical Research</p>',
  ),
  'acronym' => 
  array (
    'en_US' => 'JNSAMR',
  ...
  'contactAffiliation' => 
  array (
    'en_US' => 'National Society of Medical Student Research',
  ),
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  array (
    'en_US' => 
    array (
      'name' => 'logo-favicon-16.png',
      'uploadName' => 'favicon_en_US.png',
      'width' => 16,
      'height' => 16,
      'dateUploaded' => '2016-12-21 21:36:17',
      'altText' => 'Favicon for the National Student Assocation of Medical Research',
    ),
  ),
  'homepageImage' => 
  array (
    'en_US' => 
    array (
      'name' => 'StockImage3.jpg',
      'uploadName' => 'homepageImage_en_US.jpg',
      'width' => 2509,
      'height' => 1673,
      'dateUploaded' => '2016-12-21 21:35:54',
      'altText' => '',
    ),
  ),
  'journalThumbnail' => 
  array (
    'en_US' => 
    array (
      'name' => 'logo-square-160.png',
      'uploadName' => 'journalThumbnail_en_US.png',
      'width' => 160,
      'height' => 160,
      'dateUploaded' => '2016-12-21 21:36:47',
      'altText' => 'NSAMR logo square',
    ),
  ),
  ...
  'masthead' => 
  array (
    'en_US' => '<p>National Student Association of Medical Research</p>',
  ),
  ...
  'name' => 
  array (
    'en_US' => 'Journal of the National Student Association of Medical Research',
  ),
  'openAccessPolicy' => 
  array (
  ...
  array (
    'en_US' => 
    array (
      'name' => 'orig-logo-long-949-453.png',
      'uploadName' => 'pageHeaderLogoImage_en_US.png',
      'width' => 949,
      'height' => 453,
      'dateUploaded' => '2016-12-21 21:35:25',
      'altText' => 'JNSAMR',
    ),
  ),
  'privacyStatement' => 
  ...
  'searchDescription' => 
  array (
    'en_US' => 'The Journal of the National Student Association of Medical Research',
  ),
  'submissionChecklist' => 
  array (
    'en_US' => 
