...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'frontend/objects/issue_toc.tpl', 31, false),array('function', 'translate', 'frontend/objects/issue_toc.tpl', 77, false),array('modifier', 'escape', 'frontend/objects/issue_toc.tpl', 32, false),array('modifier', 'strip_unsafe_html', 'frontend/objects/issue_toc.tpl', 36, false),array('modifier', 'date_format', 'frontend/objects/issue_toc.tpl', 79, false),)), $this); ?>
<div class="issue-toc">
...
">
					<img class="img-responsive" src="<?php echo ((is_array($_tmp=$this->_tpl_vars['coverImagePath'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
"<?php endif; ?>>
		...
		<?php elseif ($this->_tpl_vars['issue']->hasDescription()): ?>
			<div class="description">
				<?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getLocalizedDescription())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : PKPString::stripUnsafeHtml($_tmp)); ?>
