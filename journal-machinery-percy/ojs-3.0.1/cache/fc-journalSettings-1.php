...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  'printIssn' => '',
  'publicationFee' => 0,
  'publisherInstitution' => 'National Student Association for Medical Research',
  'purchaseArticleFee' => 0,
  'referencesEnabledSubmission' => false,
  'referencesEnabledWorkflow' => false,
  ...
  'subjectEnabledSubmission' => false,
  'subjectEnabledWorkflow' => false,
  ...
  'about' => 
  array (
    'en_US' => '<p>Journal of the National Student Association for Medical Research</p>',
  ),
  'acronym' => 
  array (
    'en_US' => 'JNSAMR',
  ...
  'contactAffiliation' => 
  array (
    'en_US' => 'National Student Association for Medical Research',
  ),
  'contactTitle' => 
  array (
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  array (
    ...
    array (
      ...
      'width' => 16,
      'height' => 16,
      'dateUploaded' => '2017-01-16 15:55:19',
      'altText' => 'Favicon of the National Student Association for Medical Research',
    ),
  ),
  'journalThumbnail' => 
  array (
    'en_US' => 
    array (
      'name' => 'logo-square-80.png',
      'uploadName' => 'journalThumbnail_en_US.png',
      'width' => 80,
      'height' => 80,
      'dateUploaded' => '2017-01-16 15:55:53',
      'altText' => 'Logo of the National Student Association for Medical Research',
    ),
  ),
  ...
  'name' => 
  array (
    'en_US' => 'Journal of the National Student Association for Medical Research',
  ),
  'openAccessPolicy' => 
  array (
  ...
  array (
    'en_US' => 
    array (
      'name' => 'logo-long-3x.png',
      'uploadName' => 'pageHeaderLogoImage_en_US.png',
      'width' => 348,
      'height' => 166,
      'dateUploaded' => '2017-01-16 15:54:10',
      'altText' => 'Logo of the National Student Association for Medical Research',
    ),
  ),
  'privacyStatement' => 
