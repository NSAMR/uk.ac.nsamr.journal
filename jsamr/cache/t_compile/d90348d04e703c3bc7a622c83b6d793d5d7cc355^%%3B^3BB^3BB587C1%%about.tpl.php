...
$this->_smarty_include(array('smarty_include_tpl_file' => "frontend/components/header-fullwidth.tpl", 'smarty_include_vars' => array('pageTitleTranslated' => $this->_tpl_vars['currentJournal']->getLocalizedName())));
...
/plugins/themes/nsamr/templates/images/patterns/brick-wall-98A3AE-1920x1080.png') repeat; padding: 20px 0 20px 0;">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
        ...
        <!-- Breadcrumbs -->
        <div class="row" style="background: url('<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/nsamr/templates/images/patterns/brick-wall-E8EBEE-1920x1080.png') repeat; padding: 10px 0 10px 0;" class="col-sm-12 hidden-xs text-right">
            <div class="container">
...
/plugins/themes/nsamr/templates/images/blocks/manuscript-729617_1920.jpg" class="img-responsive" alt="">
                    </div>
                </div>
            </div>
        ...
        <!--Call to action -->
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "frontend/components/cta_readytosubmit.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
        ...
        <div class="container">
            ...
            <div class="col-md-3 col-xs-6">
                <div class="team-wrap">
                    <img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/nsamr/templates/images/team/matt-byrne.jpg" class="img-responsive">
                    <h4>Matthew Byrne</h4>
        ...
        <div class="col-md-3 col-xs-6">
            <div class="team-wrap">
                <img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/nsamr/templates/images/team/steph-rees.jpg" class="img-responsive">
        ...
        <div class="col-md-3 col-xs-6">
            <div class="team-wrap">
                <img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/nsamr/templates/images/team/helen-jackson.jpg" class="img-responsive">
                <h4>Helen Jackson</h4>
        ...
        <div class="col-md-3 col-xs-6">
            <div class="team-wrap">
                <img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/nsamr/templates/images/team/akanksha-sinha.jpg" class="img-responsive">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-xs-6">
                <div class="team-wrap">
                    <img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/nsamr/templates/images/team/ciaran-grafton.jpg" class="img-responsive">
        ...
        <div class="col-md-3 col-xs-6">
            <div class="team-wrap">
                <img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/nsamr/templates/images/team/godwin-tong.jpg" class="img-responsive">
                <h4>Godwin Tong</h4>
        ...
        <div class="col-md-3 col-xs-6">
            <div class="team-wrap">
                <img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/nsamr/templates/images/team/hamilton-morrin.jpg" class="img-responsive">
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "frontend/components/ctaMailingList.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
