{**
  ...
  *}
  <ul class="nav navbar-nav navbar-right">`
    ...
    <li class="dropdown">
      <a href="#" class="dropdown-toggle js-activated" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Contribute OLD<span class="caret"></span></a>
      <ul class="dropdown-menu">
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li><a href="{url router=$smarty.const.ROUTE_PAGE page='about' op='documentation_author'}">Documentation</a></li>
      </ul>
    </li>
