        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="left-title-bar">
                    <h2>Author and Reviewer Policies</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="tabs col-sm-12">
                <ul class="nav nav-pills nav-justified" role="tablist">
                    <li class="active"><a href="#author">Author Standards</a></li>
                    <li><a href="#reviewer">Reviewer Standards</a></li>
                </ul>
            </div>
        </div><!--END TABS-->
    </div><!--END ROW-->
...
<!--END AUTHOR STANDARDS-->


<!--START REVIEWER STANDARDS -->
<div class="container" id="reviewer">
    <div class="pull-right"><a href="#top">Back to top</a></div>
    <div class="left-title-bar">
        <h2>Reviewer standards</h2>
    </div>
    <div class="container">
        ...
        <div>
            <p>To ensure that prompt, high-quality reviews are sent to authors the information about Peer Reviewers will be stored for all JSAMR peer reviewers, including but not limited to:</p>
                <ul>
            ...
            <p>Peer reviewers are required to have completed reviewer training and registration, and must adhere to all JSAMR policies.</p> 
            <p>Reviews must be accepted or declined within 48 hours and completed within two weeks.Peer reviewers are required to have completed reviewer training and registration, and must adhere to all JSAMR policies.</p> 
        ...
        <div>
            ...
            <p>Reviewers must act professionally when representing JSAMR.</p>
        </div>                       
        <hr>
